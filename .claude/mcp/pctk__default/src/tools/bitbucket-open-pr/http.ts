...
// directly, mirroring safe-curl's http.ts. This is what lets the e2e suite swap `undici` for an
// in-memory fake (test/fixtures/fake-undici.mjs) via fake-driver-loader.mjs without touching this
// file.
