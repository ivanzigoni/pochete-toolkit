...
Todo repositório `cem-*` (e demais que adotarem o mesmo padrão) tem Husky + commitlint
instalados, com hook `commit-msg` bloqueando o commit que violar as regras sintáticas — tipo
